...
$nome_instituicao = 'Universidade do Extremo Sul de Santa Catarina';
$cnpj = '12.333.232-0001/09';
$endereco = 'Av. Universitária, 1234 - Bairro Universitário - CEP: 88802-090 - Criciúma - SC, Brasil';
$cidade = 'Criciúma';
$uf = 'SC';
$pais = 'Brasil';
$data = date('d/m/Y');
$nome_responsavel = 'Reitora Luciane Ceretta';
...
<div style="text-align: justify">
    <p>Por este termo de aceite e adesão,
        a <?=$tipo_instituicao?> <b><?= $nome_instituicao ?></b>, inscrita no CNPJ sob o nº <b><?= $cnpj ?></b>, com sede na <b><?= $endereco ?></b>
        neste ato representada pelo Reitor(a) <b><?=$nome_responsavel?></b>, doravante denominada ADERENTE, manifesta seu aceite e formaliza sua adesão
        ao <b>Fórum de Universidades pela Paz.</b>
    </p>
