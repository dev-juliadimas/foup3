                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Equipe Governança</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $oGoverana->GetTotal() ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Instituições Signatárias</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $oInstituicao->GetTotal() ?></div>
                                        </div>
                                        <div class="col-auto">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Ficar</button>
