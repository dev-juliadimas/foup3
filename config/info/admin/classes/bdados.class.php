...
class BDados
{
    ...
    function __construct($bd)
    {
        ...
        if ($this->con = mysqli_connect($this->host, $this->user, $this->pwd, $this->database, $this->porta)) {
            ...
            // 🎯 CORREÇÃO CRÍTICA: Define o conjunto de caracteres para UTF-8 
    ...
    function sql_insert($dados)
    {
        ...
        if ($res) {
            ...
            die('<table width="100%"><tr><td align="center" bgcolor="#F0F0F0"><FONT SIZE="2" face="Verdana"><b>Não foi possivel executar comando solicitado!<br>(' . $this->erro . ')</b><br>' . $sql . '<br><br><A HREF="javascript:history.back()">Voltar</A></font></td></tr></table>');
            return false;
        }
    }
     ...
     *
     * @author Marcelo Mazon
     * @history 09/10/2007 - Versão inicial
     */

    function sql_delete($dados)
    {
        if (!$dados) // se não passou dados, tenta pegar os dados setados no objeto
        {
        ...
        if ($res) {
            ...
            $this->erro = mysqli_errno($this->con) . ": " . mysqli_error($this->con) . "\n";
            die('<table width="100%"><tr><td align="center" bgcolor="#F0F0F0"><FONT SIZE="2" face="Verdana"><b>Não foi possível executar comando solicitado!<br>(' . $this->erro . ')</b><br><A HREF="javascript:history.back()">Voltar</A></font></td></tr></table>');
            return false;
        }
    }
