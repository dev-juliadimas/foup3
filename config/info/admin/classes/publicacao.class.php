...
class Publicacao extends BDados
{
	public $bloco = array("tabela" => "publicacao", "order_by" => "id");
    ...
    public function GetAutores($param=false)
    {
        $busca = '1 = 1 ';
        if ($param)
        {
            $busca .= "and nome like '%".$param['busca']."%'";
        }
        $sql = "select id, nome as text from autor where $busca order by nome";
