...
if (isset($_POST['bt_gravar']))
{
    ...
    $oSetor->Update($_POST);
    header("Location: usuarios.php?".cript("m=".$get['m']."&p=".$get['p']."&msg=Setor ".($_POST['cd_usuario']>0?'atualizado':'cadastrado')." com sucesso"));
    exit;
}
if (isset($_POST['bt_excluir']))
{
    $oSetor->Delete($_POST);
    header("Location: usuarios.php?".cript("m=".$get['m']."&p=".$get['p']));
    exit;
}

//pega os dados para edição
if (isset($get['i']))
    $oSetor->GetDados(array('cd_usuario'=>$get['i']));
else
    $oSetor->GetDados(array('cd_usuario'=>'0',true));
...
<head>
    ...
    <title>Setor <?=$oSetor->dados->nm_usuario?></title>
                        ...
                        <form class="needs-validation" method="POST" action="<?=$_SERVER['PHP_SELF']."?".cript("m=".$get['m']."&p=".$get['p']);?>">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  value="<?=$oSetor->dados->cd_usuario?>" minlength="1" maxlength="10" class="form-control"
                                               id="cd_usuario" name="cd_usuario" readonly>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="nm_usuario" class="required">Nome *</label>
                                        <input value="<?=$oSetor->dados->nm_usuario?>" type="text" minlength="3" maxlength="200" class="form-control" id="nm_usuario" name="nm_usuario" required>
                                    </div>
                                </div>

                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="nm_usuario" class="required">E-mail *</label>
                                        <input value="<?=$oSetor->dados->email?>" type="mail" minlength="3" maxlength="200" class="form-control" id="email" name="email" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  value="<?=$oSetor->dados->login?>" minlength="1" maxlength="10" class="form-control"
                                               id="login" name="login" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="usuarios.php?<?=cript("m=".$get['m']."&p=".$get['p']);?>" type="button" class="btn btn-secondary ml-1">Cancelar</a>
                                </div>
                            </div>
                        </form>
