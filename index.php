...
<body>
  ...
  <section class="vh-100 d-flex align-items-center justify-content-center"
    ...
    <div class="container w-50 text-start text-light">
      ...
      <div class="d-flex flex-wrap gap-2">
        <a href="#facaParte" class="btn border-white rounded-1 px-5 fw-bold text-light">FAÇA PARTE</a>
        <a href="sobre.php" class="btn rounded-1 btn-sm px-3 fw-bold text-light" style="background: orange;">Sobre</a>
      </div>
    </div>
  ...
  <section class="partners py-5 d-flex flex-column align-items-center justify-content-center gap-3" 
    ...
    <p class="text-light fw-bold" style="color: #868c90 !important;"> Parceiros</p>
    <ul class="d-flex flex-wrap justify-content-center align-items-center m-0 gap-4 list-unstyled">
      ...
      <li><img width="130px" src="arquivos/index/logo-parceiros/patrocinador-16.png" class="img-fluid"></li>-->
         ...
         <a href="#" class="btn btn-lg px-5 fw-bold text-dark rounded-1" style="background: #868c90 !important; color:#ffffff !important ;">Ver Todas</a>
  </section>

  <section class="be-part vh-100 d-flex align-items-center" id="facaParte" style="background-color: #005D83;">
    <div
      ...
      <div class="text-start">
        ...
        <div class="d-flex flex-wrap gap-2">
          <a href="facaParte.php?tipo=voluntario" class="btn border-white rounded-0 px-5 fw-bold text-light">
            <i class="fa-solid fa-users"></i>
            VOLUNTÁRIO
          </a>
          <a href="facaParte.php?tipo=instituicao" class="btn border-white rounded-0 px-5 fw-bold text-light">
    ...
    <div class="container">
      <div class="row align-items-center g-4">
        ...
        <div class="col-12 col-lg-6 text-light ps-lg-5">
          ...
          <p class="lead mb-1">Encerramento do primeiro fórum de universidades pela paz</p>
