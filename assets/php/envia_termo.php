...
// Recipients
$fromEmail = 'marcelomazon@gmail.com'; // Email address that will be in the from field of the message.
$fromName = 'Marcelo Mazon'; // Name that will be in the from field of the message.
$sendToEmail = 'contato@foup.org'; // Email address that will receive the message with the output of the form
$sendToName = 'FOUP'; // Name that will receive the message with the output of the form
...
$smtpUsername = 'sendmail'; // SMTP username ie. gmail address
$smtpPassword = 'Sndm@2023!'; // SMTP password ie gmail password
...
$emailTextHtml = '<p>teste enviando e-mail do site</p>';
